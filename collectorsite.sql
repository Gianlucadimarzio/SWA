...
--
-- Host: 127.0.0.1
-- Creato il: Lug 19, 2021 alle 22:58
...
(3, 'Manuele', 'Pozzolo'),
(4, 'Manuele', 'Pozzolooo'),
(5, 'Manueleeee', 'Pozzollo'),
(6, 'Manuelaaa', 'Pozzollo'),
(7, 'ManuelaaaA', 'Pozzollo'),
(8, 'Giulio', 'Golia'),
(9, 'stecujbas', 'Loffone'),
(10, 'Antonio', 'Banderas'),
(11, '', ''),
...
(1, 1, 'Summer2k21', 'pubblica'),
(2, 1, 'Primavera2k21', 'condivisa'),
(3, 1, 'Inverno2k21', 'privata'),
(8, 1, 'Hit Estive 2000', 'privata');
...
--
-- Dump dei dati per la tabella `collezione_condivisa`
--

INSERT INTO `collezione_condivisa` (`id`, `id_collezione`, `id_utente`) VALUES
(1, 2, 2);
...
(1, 12, 'StecinosiPropositi'),
(2, 1, 'Disco PoPoPo'),
(20, 3, 'Disco'),
(21, 3, 'Disco'),
(22, 4, 'Discoooo'),
(23, 5, 'Discoooo2312dwsd'),
(24, 5, 'Discoooo2312dwsd'),
(25, 5, 'Discoooo2312dwsd'),
(26, 5, 'Discoooo2312dwsd'),
(27, 6, 'Discooooff'),
(28, 7, 'DiscooooffF'),
(29, 7, 'DiscooooKebab');
...
(1, 'Mario', '123', 'Mario3291cea2-c2dc-4145-bdb4-b379fd372d82'),
(2, 'Giovanni', '123', NULL),
(3, 'cacca', 'popo', NULL);
...
--
ALTER TABLE `collezione`
  ADD CONSTRAINT `collezione_ibfk_1` FOREIGN KEY (`id_utente`) REFERENCES `utente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
